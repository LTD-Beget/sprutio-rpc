...
class CopyFromWebDavToSftp(BaseWorkerCustomer):
    def __init__(self, source, target, paths, overwrite, *args, **kwargs):
        super(CopyFromWebDavToSftp, self).__init__(*args, **kwargs)
    ...
    def upload_files_recursive_to_sftp(self, path, read_path, target_path, sftp, operation_progress):
        ...
        try:
            ...
            if os.path.isdir(read_file_path):
                ...
                self.make_directory_on_sftp(destination, sftp)
                ...
                for current, dirs, files in os.walk(read_file_path):
                    ...
                    for d in dirs:
                        ...
                        self.make_directory_on_ftp(next_directory, sftp)
                    for f in files:
