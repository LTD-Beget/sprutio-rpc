...
class WebDav:
    ...
    def download_dir(self, source, target, overwrite=False):
        ...
        try:
                    ...
                    try:
                        ...
                        if first_level:
                            ...
                            try:
                                ...
                                self.logger.error(
                                        "Error in WebDav download_dir(): %s, traceback = %s" % (
            ...
            self.logger.error("Error in WebDav download_dir(): %s, traceback = %s" % (str(e), traceback.format_exc()))
        ...
        try:
            ...
            if self.webdavClient.path.exists(target):
                try:
                    ...
                    self.logger.error("Error in WebDav chmod(): %s, traceback = %s" % (str(e), traceback.format_exc()))
                    ...
                    try:
                        ...
                        for name in files:
                            ...
                            try:
                                ...
                                files_failed.append(source_filename)
                                self.logger.error(
                                        "Error in WebDav upload_dir(): %s, traceback = %s" % (
                                            str(e), traceback.format_exc()))
                        ...
                        failed.extend(dirs_failed)
                        self.logger.error(
                                "Error in WebDav upload_dir(): %s, traceback = %s" % (str(e), traceback.format_exc()))
    ...
    def fclose(self, pid):
        try:
            ...
            self.logger.error("Error in WebDav fclose(): %s, traceback = %s" % (str(e), traceback.format_exc()))
            ...
            if self.webdavClient.path.isdir(self.to_byte(source)):
                ...
                for current, dirs, files in tree:
                    ...
                    try:
                        ...
                        failed.extend(dirs_failed)
                        self.logger.error(
                                "Error in WebDav copy_dir(): %s, traceback = %s" % (str(e), traceback.format_exc()))
